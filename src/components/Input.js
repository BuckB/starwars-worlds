...
class Input extends Component {
    render() {
        return (
            <div>
                <input name={this.props.name} className={this.props.class} type={this.props.type} onChange={this.props.onChangeFunction} onBlur={this.props.onBlurFunction} value={this.props.value} placeholder={this.props.placeholder}
